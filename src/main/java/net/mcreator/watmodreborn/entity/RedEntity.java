...
public class RedEntity extends TamableAnimal {
	public RedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WatModRebornModEntities.RED.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, CatGodEntity.class, true, true));
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		RedEntity retval = WatModRebornModEntities.RED.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(WatModRebornModEntities.RED.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getBlockState(pos.below()).is(BlockTags.ANIMALS_SPAWNABLE_ON) && world.getRawBrightness(pos, 0) > 8));
		DungeonHooks.addDungeonMob(WatModRebornModEntities.RED.get(), 180);
	}
