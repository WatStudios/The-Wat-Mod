...
public class SculkCatEntity extends Monster {
	public SculkCatEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WatModRebornModEntities.SCULK_CAT.get(), world);
	}

	public SculkCatEntity(EntityType<SculkCatEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Blocks.SCULK_SENSOR));
	}
	...
	public static void init() {
		SpawnPlacements.register(WatModRebornModEntities.SCULK_CAT.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
