...
public class CorruptedSirMeowsEntity extends Monster {
	public CorruptedSirMeowsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WatModRebornModEntities.CORRUPTED_SIR_MEOWS.get(), world);
	}

	public CorruptedSirMeowsEntity(EntityType<CorruptedSirMeowsEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(1f);
		xpReward = 2;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(14, new NearestAttackableTargetGoal(this, Player.class, true, true));
		this.targetSelector.addGoal(15, new NearestAttackableTargetGoal(this, ServerPlayer.class, true, true));
		this.goalSelector.addGoal(16, new RestrictSunGoal(this));
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(WatModRebornModItems.SIR_MEOWS_SPAWN_EGG.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(WatModRebornModEntities.CORRUPTED_SIR_MEOWS.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
