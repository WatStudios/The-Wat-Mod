...
import net.mcreator.watmodreborn.procedures.AlexEntityDiesProcedure;
import net.mcreator.watmodreborn.init.WatModRebornModEntities;

public class AlexEntity extends TamableAnimal {
	public AlexEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WatModRebornModEntities.ALEX.get(), world);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		AlexEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AlexEntity retval = WatModRebornModEntities.ALEX.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(WatModRebornModEntities.ALEX.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getBlockState(pos.below()).is(BlockTags.ANIMALS_SPAWNABLE_ON) && world.getRawBrightness(pos, 0) > 8));
		DungeonHooks.addDungeonMob(WatModRebornModEntities.ALEX.get(), 180);
	}
