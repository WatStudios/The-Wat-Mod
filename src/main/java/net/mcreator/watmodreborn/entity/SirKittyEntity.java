...
import net.mcreator.watmodreborn.procedures.SirKittyEntityDiesProcedure;
import net.mcreator.watmodreborn.init.WatModRebornModEntities;

public class SirKittyEntity extends TamableAnimal {
	public SirKittyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(WatModRebornModEntities.SIR_KITTY.get(), world);
	}

	public SirKittyEntity(EntityType<SirKittyEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 1;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		super.die(source);
		SirKittyEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SirKittyEntity retval = WatModRebornModEntities.SIR_KITTY.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(WatModRebornModEntities.SIR_KITTY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getDifficulty() != Difficulty.PEACEFUL && Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random)));
		DungeonHooks.addDungeonMob(WatModRebornModEntities.SIR_KITTY.get(), 180);
	}
